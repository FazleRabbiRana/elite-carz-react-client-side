...
const PrivacyPolicy = () => {
	return (
		<>
			<HeaderNavbar />
			<main id="policy_page" className="policy-page pt-16 md:pt-20">
				<section className="py-8 lg:py-12">
					<div className="container text-sm leading-loose">
						<h2 className="text-3xl mb-2">Privacy Policy</h2>
						<p className="mb-8">Last updated: November 22, 2021</p>
						...
						<p className="mt-2">
							...
							Policy. This Privacy Policy's another online copy can be found{' '}
							<a
								href="https://www.freeprivacypolicy.com/live/14f6b578-3486-4325-bad1-ebcecec9e7f6"
								target="_blank" 
								rel="noreferrer"
						...
						<h2 className="text-xl mt-4 mb-2">Interpretation and Definitions</h2>
						<h3 className="text-lg tracking-normal mt-4 mb-1">Interpretation</h3>
						<p className="mt-2">
							The words of which the initial letter is capitalized have meanings defined under the
							following conditions. The following definitions shall have the same meaning regardless
							of whether they appear in singular or in plural.
						</p>
						<h3 className="text-lg tracking-normal mt-4 mb-1">Definitions</h3>
						...
						<ul>
							...
							<li>
								<p className="mt-2">
									<strong>Website</strong> refers to Elite Carz, accessible from{' '}
									<a
										href="https://elite-carz.web.app/"
						...
						<h2 className="text-xl mt-4 mb-2">Collecting and Using Your Personal Data</h2>
						<h3 className="text-lg tracking-normal mt-4 mb-1">Types of Data Collected</h3>
						<h3 className="text-lg tracking-normal mt-4 mb-1">Personal Data</h3>
						<p className="mt-2">
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Usage Data</h3>
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Tracking Technologies and Cookies</h3>
						<p className="mt-2">
						...
						<ul>
							...
							<li>
								...
								objects (or Flash Cookies) to collect and store information about Your preferences
								or Your activity on our Service. Flash Cookies are not managed by the same browser
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Use of Your Personal Data</h3>
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Retention of Your Personal Data</h3>
						<p className="mt-2">
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Transfer of Your Personal Data</h3>
						<p className="mt-2">
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Disclosure of Your Personal Data</h3>
						<h3 className="text-lg tracking-normal mt-4 mb-1">Business Transactions</h3>
						<p className="mt-2">
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Law enforcement</h3>
						<p className="mt-2">
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Other legal requirements</h3>
						<p className="mt-2">
						...
						<h3 className="text-lg tracking-normal mt-4 mb-1">Security of Your Personal Data</h3>
						<p className="mt-2">
						...
						<h2 className="text-xl mt-4 mb-2">Children's Privacy</h2>
						<p className="mt-2">
						...
						<h2 className="text-xl mt-4 mb-2">Links to Other Websites</h2>
						<p className="mt-2">
						...
						<h2 className="text-xl mt-4 mb-2">Changes to this Privacy Policy</h2>
						<p className="mt-2">
						...
						<h2 className="text-xl mt-4 mb-2">Contact Us</h2>
						<p className="mt-2">If you have any questions about this Privacy Policy, You can contact us:</p>
						<ul>
							<li>
								<p className="mt-2">By email: help@elite-carz.web.app</p>
							</li>
							<li>
								<p className="mt-2">
